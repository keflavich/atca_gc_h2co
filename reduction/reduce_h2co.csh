...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos3.map beam=BEAMS/h2comos3.beam imsize=1024 cell=2 slop=0.9 robust=2 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos4.map beam=BEAMS/h2comos4.beam imsize=1024 cell=2 slop=0.9 robust=2 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos5.map beam=BEAMS/h2comos5.beam imsize=1024 cell=2 slop=0.9 robust=2 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos6.map beam=BEAMS/h2comos6.beam imsize=1024 cell=2 slop=0.9 robust=2 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos3_r0.map beam=BEAMS/h2comos3_r0.beam imsize=1024 cell=2 slop=0.9 robust=0 options=double
rm -rf CLEANS/h2comos3.clean
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos4_r0.map beam=BEAMS/h2comos4_r0.beam imsize=1024 cell=2 slop=0.9 robust=0 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos5_r0.map beam=BEAMS/h2comos5_r0.beam imsize=1024 cell=2 slop=0.9 robust=0 options=double
...
invert vis=SOURCES/m02.uvlin map=MAPS/h2comos6_r0.map beam=BEAMS/h2comos6_r0.beam imsize=1024 cell=2 slop=0.9 robust=0 options=double
