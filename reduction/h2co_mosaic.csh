...
invert vis=@h2cosources map=MAPS/h2comosaic.map beam=BEAMS/h2comosaic.beam imsize=1000 cell=3 slop=0.9 robust=2 options=double,mosaic line=velocity,400,-200,2,2
...
invert vis=SOURCES/h2comosaic_concat.uvlin map=MAPS/h2comosaic_contsub.map beam=BEAMS/h2comosaic_contsub.beam imsize=1000 cell=3 slop=0.9 robust=2 options=double,mosaic line=velocity,400,-200,2,2
...
invert vis=SOURCES/h2comosaic_concat.uvlin map=MAPS/h2comosaic_r0_contsub.map beam=BEAMS/h2comosaic_r0_contsub.beam imsize=1536 cell=1 slop=0.9 robust=0 options=double,mosaic line=velocity,400,-200,2,2
